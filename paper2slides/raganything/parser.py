    ...
    def convert_office_to_pdf(
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                # Copy PDF to final outputs directory
...
class MineruParser(Parser):
    ...
    and generating markdown and JSON outputs.
    ...
    def _run_mineru_command(
        ...
        try:
            ...
            # Function to read outputs from subprocess and add to queue
            ...
            while process.poll() is None:
                ...
                try:
                    while True:
                        ...
                        # Log mineru outputs with INFO level, prefixed with [MinerU]
            ...
            # Process any remaining outputs after process completion
            try:
                while True:
                    prefix, line = stdout_queue.get_nowait()
                    output_lines.append(line)
    ...
    def _read_output_files(
        ...
        """
        Read the outputs files generated by mineru
    ...
    def parse_pdf(
        ...
        **kwargs,
        ...
        try:
            ...
            # Read the generated outputs files
...
class DoclingParser(Parser):
    ...
    into structured data and generating markdown and JSON outputs.
    """
        ...
        **kwargs,
        ...
        try:
            ...
            if result_json.stdout:
                logging.debug(f"JSON cmd outputs: {result_json.stdout}")
            if result_md.stdout:
                logging.debug(f"Markdown cmd outputs: {result_md.stdout}")
        except subprocess.CalledProcessError as e:
    ...
    def _read_output_files(
        ...
        """
        Read the outputs files generated by docling and convert to MinerU format
...
def main():
    ...
    parser.add_argument("--outputs", "-o", help="Output directory path")
    parser.add_argument(
        "--method",
        "-m",
